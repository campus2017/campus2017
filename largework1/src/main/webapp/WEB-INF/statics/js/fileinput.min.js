    ...
    i = {
        ...
        constructor: t, _cleanup: function () {
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var T, E, x, F, S, I, k, P, z, A, $ = v + e, D = p + "-" + $, U = t[e], B = U.name ? n.slug(U.name) : "", j = (U.size || 0) / 1e3, L = "", O = i.objUrl.createObjectURL(U), R = 0, Z = "";
            ...
            var i = this, t = {"class": "file-input file-input-new" + (i.rtl ? " kv-rtl" : "")}, a = e(document.createElement("div")).attr(t).html(i._renderMain());
