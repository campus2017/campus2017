<%@ page import="com.springapp.mvc.Word" %>
...
<div align="center">
    <table>
        ...
        <tr id="file" style="visibility: hidden">
            <td>
                <form action="/fileCounter.qunar" method="post" enctype="multipart/form-data">
                    <a href="#">
        ...
        <tr id="text">
            <td>
                <table>
                    <tr>
                        <form id="form" action="textCounter.qunar" method="post">
            ...
            <td>
                ...
                <table border="1" cellpadding="0" cellspacing="0" width="233px">
                    ...
                    <tr align="center">
                        ...
                        <td width="200px" height="35"><%= word == null ? 0 : word.getEnCount()%>
                        </td>
                    </tr>
                    <tr align="center">
                        <td width="200px" height="35">数字</td>
                        <td width="200px" height="35"><%= word == null ? 0 : word.getDigitCount()%>
                        </td>
                    </tr>
                    <tr align="center">
                        <td width="200px" height="35">中文汉字</td>
                        <td width="200px" height="35"><%= word == null ? 0 : word.getChCount()%>
                        </td>
                    </tr>
                    <tr align="center">
                        <td width="200px" height="35">中英文标点符号</td>
                        <td width="200px" height="35"><%= word == null ? 0 : word.getPunCount()%>
                        </td>
                    </tr>
                </table>
            </td>
