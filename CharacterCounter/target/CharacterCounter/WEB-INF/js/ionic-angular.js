 ...
 * .contr(function($scope, $ionicActionSheet, $timeout) {
 *
 ...
 * navigate forward to the same view again, it'll create a new DOM element and contr
 ...
 * .contr('LoadingCtrl', function($scope, $ionicLoading) {
 *   $scope.show = function() {
 *     $ionicLoading.show({
 *       template: 'Loading...'
 *     });
 ...
 * });
 * app.contr('AppCtrl', function($scope, $ionicLoading) {
 ...
 * @description
 *
 * Related: {@link ionic.contr:ionicModal ionicModal contr}.
 *
 ...
 * .contr('MyController', function($scope, $ionicModal) {
...
function($rootScope, $ionicBody, $compile, $timeout, $ionicPlatform, $ionicTemplateLoader, $$q, $log, $ionicClickBlock, $window, IONIC_BACK_PRIORITY) {
  ...
  var ModalView = ionic.views.Modal.inherit({
     ...
     * @description Creates a new modal contr instance.
  ...
  return {
     ...
     * content.
     * @param {object} options Options to be passed {@link ionic.contr:ionicModal#initialize ionicModal#initialize} method.
     * @returns {object} An instance of an {@link ionic.contr:ionicModal}
     * contr.
     */
     ...
     * an {@link ionic.contr:ionicModal} contr.
     */
 ...
 * @description
 *
 * Related: {@link ionic.contr:ionicPopover ionicPopover contr}.
 *
 ...
 * ```js
 * angular.module('testApp', ['ionic'])
 * .contr('MyController', function($scope, $ionicPopover) {
 *
 *   // .fromTemplate() method
...
function($ionicModal, $ionicPosition, $document, $window) {
   ...
   * @description Creates a new popover contr instance.
   * @param {object} options An options object with the following properties:
   *  - `{object=}` `scope` The scope to be a child of.
   *    Default: creates a child of $rootScope.
   *  - `{boolean=}` `focusFirstInput` Whether to autofocus the first input of
  ...
  return {
     ...
     * @returns {object} An instance of an {@link ionic.contr:ionicPopover}
     * contr (ionicPopover is built on top of $ionicPopover).
     */
    fromTemplate: function(templateString, options) {
     ...
     * @param {object} options Options to be passed to the initialize method.
     * @returns {promise} A promise that will be resolved with an instance of
     * an {@link ionic.contr:ionicPopover} contr (ionicPopover is built on top of $ionicPopover).
     */
 ...
 * ```js
 *angular.module('mySuperApp', ['ionic'])
 *.contr('PopupCtrl',function($scope, $ionicPopup, $timeout) {
 *
 * // Triggered on a button click, or some other target
...
function($scope,
  ...
  //Attach self to element as a contr so other directives can require this contr
...
function($scope, $attrs, $ionicSideMenuDelegate, $ionicPlatform, $ionicBody, $ionicHistory, $ionicScrollDelegate, IONIC_BACK_PRIORITY) {
  ...
  /**
   * Set the content view contr if not passed in the constructor options.
   *
    ...
    compile: function(element, attr) {
      ...
      function prelink($scope, $element, $attr) {
        ...
        if ($attr.scroll === "false") {
          ...
          // init scroll contr with appropriate options
 ...
 * event from your contr (see below example).
 *
 ...
 * @usage
 * ```html
 * <ion-content ng-contr="MyController">
 *   <ion-list>
 *   ....
 *   ....
 *   </ion-list>
  ...
  return {
    ...
    link: function($scope, $element, $attrs, ctrls) {
      ...
      if (jsScrolling) {
        ...
        // if there's no scroll contr, and no overflow scroll div, infinite scroll wont work
        if (!scrollEl) {
...
*
* ```html
* <ion-list ng-contr="MyCtrl" show-reorder="true">
...
*
*```javascript
* app.contr('MyCtrl', function($scope) {
 ...
 * recreated, controllers are not loading again on a subsequent viewing. If the app/contr
 ...
 * If you navigate forward to the same view again, it'll create a new DOM element and contr
 ...
 * ```js
 * angular.module('testApp', ['ionic'])
 * .contr('MyController', function($scope, $http) {
 *   $scope.items = [1,2,3];
...
.directive('ionRefresher', [function() {
  return {
    ...
    link: function($scope, $element, $attrs, ctrls) {
      ...
      // JS Scrolling uses the scroll contr
 ...
 * <ion-side-menus>
 *   <!-- Center content -->
 *   <ion-side-menu-content ng-contr="ContentController">
 *   </ion-side-menu-content>
 *
 *   <!-- Left menu -->
 *   <ion-side-menu side="left">
 ...
 * affect your contr logic. To know when a view has entered or left, events
 ...
 *   <td>The view's contr has been destroyed and its element has been
