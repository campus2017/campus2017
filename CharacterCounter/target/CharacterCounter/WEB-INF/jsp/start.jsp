...
<div id="file2" class="change fixed" style="width:400px;display:none;">
    ...
    <div class="button button-small button-calm " style="height:30px;margin:0 0 0 20px ;padding:0 30px;float:left;"
         ng-click="count()">统计
    </div>
    <div class="button  button-small "
         style="height:30px;margin:8px 0 0  20px ;padding:0 17.6px;float:left;background: orange;" ng-click="clear()">
        <b>清空内容</b></div>
</div>
<br/>
