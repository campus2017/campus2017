...
public class Counter {
     ...
     * @return
     */
    public Map<Integer, com.qunar.pojo.Words> getTop3(){
        Map<Integer, com.qunar.pojo.Words> mim = new HashMap<>();
     ...
     * @param val
     */
    private void addToMIM(Map<Integer, com.qunar.pojo.Words> mim, String key, Integer val){
        if (mim.size() < 3){
            mim.put(mim.size()+1,new com.qunar.pojo.Words(key,val));
            sortTop3(mim);
        }
        else {
            if (val > mim.get(3).getVal()){
                mim.put(3,new com.qunar.pojo.Words(key,val));
                sortTop3(mim);
            }
        }
    }
     ...
     * @param mim
     */
    private void sortTop3(Map<Integer, com.qunar.pojo.Words> mim){
        com.qunar.pojo.Words temp;
