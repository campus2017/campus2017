...
public class modelUtils {
    ...
    public static Statics init(Statics t){
        t.setNumber(0);
        t.setEnglish(0);
        t.setChinese(0);
        t.setBiaodian(0);
    ...
    public static Statics addOpt(Statics a, Statics b){
        Statics sum = new Statics();
    ...
    public static Statics readFileByLines(String fileName) {
        Statics statics = new Statics();
        Statics resStatics = new Statics();
        init(statics);
        init(resStatics);
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                tempString = tempString.replaceAll("\n","");
                tempString = tempString.replaceAll("\t","");
                resStatics = addOpt(resStatics,getObject(tempString));
                line++;
            }
            reader.close();
        } catch (IOException e) {
...
//    public static Statics getFileObject(MultipartFile multipartFile){
//        try {
...
//    }
    ...
    public static Statics getObject(String text){
        Statics myobj = new Statics();
