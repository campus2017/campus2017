...
public class ExchangeRate {
    private List<String> day = new ArrayList<>();   //存放日期数据
    private List<String> usd = new ArrayList<>();   //存放美元汇率
    private List<String> eur = new ArrayList<>();   //存放欧元汇率
    private List<String> hkd = new ArrayList<>();   //存放港币汇率
