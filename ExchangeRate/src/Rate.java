...
public class Rate {
    ...
    public List<List<RateImpl>> getRate() {
        List<List<RateImpl>> rates = new ArrayList<>(3);

        for (int i = 0; i < xmls.length; i++) {
            ArrayList<RateImpl> list = new ArrayList<>(30);
            rates.add(list);
            ...
            try {
                ...
                for (int j = 0; j < length && j < 30; j++) {
                    ...
                    list.add(new RateImpl(date.getFirstChild().getNodeValue(),
